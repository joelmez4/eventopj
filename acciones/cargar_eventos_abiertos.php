        ...
        while($fila=$resultado->fetch_assoc()) 
            {
                ...
                $salida.=" <tr>
                                ...
                                <td class='text-center '>
                                    <a class='btn btn-primary btn-block mb-2' href='registrar_entrada_evento.php?id_evento=".$fila['nro_evento']."' role='button'>Registrar Entrada</a>
                                    <a class='btn btn-success btn-block' href='registrar_salida_evento.php?id_evento=".$fila['nro_evento']."' role='button'>Registrar Salida</a>
                                </td>
                            </tr>";
            }     
        $salida.="</tbody></table>";                            
