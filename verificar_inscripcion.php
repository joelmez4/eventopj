        ...
        <div class="container-fluid">
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        echo "<div class='p-3 mb-2 bg-danger text-white container'>Usted no esta inscrito dirijase a los eventos disponibles de la Corte Superior de Justicia de Apurimac, para realizar la inscripcion respectiva</div>"; //mensaje
                    }
                }            
            ?>   
